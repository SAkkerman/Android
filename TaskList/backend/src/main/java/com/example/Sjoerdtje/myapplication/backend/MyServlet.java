...
package com.example.Sjoerdtje.myapplication.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.example.Sjoerdtje.myapplication.backend.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Firebase firebase = new Firebase("https://blistering-fire-249.firebaseio.com/todoItems");
        firebase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("nagger@[blistering-fire-249].appspotmail.com",
                            "Todo Nagger"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("sakkerman@roc-dev.com", "Recipient"));
